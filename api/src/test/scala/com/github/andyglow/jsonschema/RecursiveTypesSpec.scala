      ...
      "product types. inner references root" in {
        ...
        json.Json.schema[SList] shouldEqual `def`(
          ...
          `object`(
            ...
            Field(
              "tail",
              `ref`("com.github.andyglow.jsonschema.RecursiveTypesSpec.case1.SList"),
              required = false
            )
          )
        )
        ...
        json.Json.schema[Node] shouldEqual `def`(
          ...
          `oneof`.of(
            `object`(
              ...
              Field(
                "children",
                `array`(`ref`("com.github.andyglow.jsonschema.RecursiveTypesSpec.case2.Node")),
                required = true
              )
            ),
            `object`(Field("content", `string`, required = true))
          )
        )
      }
